...
# ✅ FIX: Sequence sorting ke liye function
...
async def rclone_upload_file(message, file_path, queue_pos=None):
    ...
    # ✅ FIX: Mega aur dusri clouds me errors kam karne ke liye '--ignore-checksum' add kiya
...
async def upload_file(client, message, file_path, user_mention, queue_pos=None):
    try:
        ...
        try:
            # ✅ FIX: Photo ko send_photo aur Video ko send_video se bhejna
            if is_image:
